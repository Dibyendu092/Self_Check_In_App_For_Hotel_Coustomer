...
public class itcCheckOutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_itc_check_out);
        ...
        CheckOutbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                detailsofCheckOut();
                Toast.makeText(itcCheckOutActivity.this, "You are Succesfully Check Out.", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
    public void detailsofCheckOut(){
        ...
        databaseReference1.child("India").child("Kolkata").child("ITC").child("Check Out Details").child(userUid1).child("Booking id:").setValue(P);
        databaseReference1.child("India").child("Kolkata").child("ITC").child("Check Out Details").child(userUid1).child("Name").setValue(q);
        databaseReference1.child("India").child("Kolkata").child("ITC").child("Check Out Details").child(userUid1).child("Check out Time").setValue(r);
