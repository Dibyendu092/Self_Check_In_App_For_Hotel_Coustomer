...
public class Details extends AppCompatActivity {
    ...
    public void detailOfbooking(){
        ...
        databaseReference.child("Check in Details").child(userUid1).child("Booking id").setValue(val);
        databaseReference.child("Check in Details").child(userUid1).child("Name").setValue(a);
        databaseReference.child("Check in Details").child(userUid1).child("Email").setValue(b);
        databaseReference.child("Check in Details").child(userUid1).child("Addhar No").setValue(c);
        databaseReference.child("Check in Details").child(userUid1).child("Phone No").setValue(d);
        databaseReference.child("Check in Details").child(userUid1).child("Check_in time").setValue(e);
